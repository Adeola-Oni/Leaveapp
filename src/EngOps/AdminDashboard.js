...
class AdminDashboard extends Component{
    ...
    componentDidMount(){
        ...
        // axios.get('https://leaveappjson.herokuapp.com/edutech/1').then(res=>{
        //     let edutech = res.data.number;
        //     this.setState({edutech})
        // }).catch(err=>console.log(err))

        // axios.get('https://leaveappjson.herokuapp.com/powertech/1').then(res=>{
        //     let powertech = res.data.number;
        //     this.setState({powertech})
        // }).catch(err=>console.log(err))

        // axios.get('https://leaveappjson.herokuapp.com/gsv/1').then(res=>{
        //     let gsv = res.data.number;
        //     this.setState({gsv})
        // }).catch(err=>console.log(err))

        // axios.get('https://leaveappjson.herokuapp.com/gardendata/1').then(res=>{
        //     let gardendata = res.data.number;
        //     this.setState({gardendata})
        // }).catch(err=>console.log(err))

        // axios.get('https://leaveappjson.herokuapp.com/vigipay/1').then(res=>{
        ...
        // axios.get('https://leaveappjson.herokuapp.com/cooporate/1').then(res=>{
