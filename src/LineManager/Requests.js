...
class Requests extends Component{
    ...
    getFrontData(){
        axios.get('https://leaveappjson.herokuapp.com/frontend/1').then(res=>{
            this.setState({frontend : res.data.number})
        }).catch(err=>console.log(err));
    }

    getHniData(){
        axios.get('https://leaveappjson.herokuapp.com/hni/1').then(res=>{
            this.setState({hni : res.data.number})
        }).catch(err=>console.log(err));
    }

    getBackend(){
        axios.get('https://leaveappjson.herokuapp.com/backend/1').then(res=>{
            this.setState({backend : res.data.number})
        }).catch(err=>console.log(err));
    }

    getQA(){
        axios.get('https://leaveappjson.herokuapp.com/qa/1').then(res=>{
            this.setState({qa : res.data.number})
        }).catch(err=>console.log(err));
    }

    getDevops=()=>{
        axios.get('https://leaveappjson.herokuapp.com/devops/1').then(res=>{
            this.setState({devops : res.data.number})
        }).catch(err=>console.log(err));
    }

    getSupport(){
        axios.get('https://leaveappjson.herokuapp.com/support/1').then(res=>{
            this.setState({support : res.data.number})
        }).catch(err=>console.log(err));
    }

    getData=()=>{
        axios.get('https://leaveappjson.herokuapp.com/engineers/1').then(res=>{
            this.setState({totalNumber : res.data})
        }).catch(err=>console.log(err));
    }

    getAvitech=()=>{
        axios.get('https://leaveappjson.herokuapp.com/avitech/1').then(res=>{
            this.setState({avitech : res.data.number})
        }).catch(err=>console.log(err));
    }

    getFinatech=()=>{
        axios.get('https://leaveappjson.herokuapp.com/finatech/1').then(res=>{
    ...
    approveHandler(e, ident){
        ...
        axios.patch('https://leaveappjson.herokuapp.com/requests/'+ident, data).then((res)=>{
            let x = res.data;
            if(x.staffType === 'Engineer'){
                let number = this.state.totalNumber + 1;
                axios.patch('https://leaveappjson.herokuapp.com/engineers', number).then(res=>alert(res.data)).catch(err=>console.log(err));
                
                if(x.competency === "UI/UX"){
                    let frontend = parseInt(this.state.frontend) + 1;
                    let data = {"number": frontend}
                    axios.patch('https://leaveappjson.herokuapp.com/frontend/1', data).then(()=>{
                        this.fetchRequests();
                        this.showRequests();
                        this.getFrontData();
                    }).catch(err=>console.log(err));
                    ...
                    let data = {"number": hni}
                    axios.patch('https://leaveappjson.herokuapp.com/hni/1', data).then(()=>{
                        this.fetchRequests();
                        this.showRequests();
                        this.getHniData();
                    }
                    ...
                    axios.patch('https://leaveappjson.herokuapp.com/backend/1', data).then(()=>{
                        this.fetchRequests();
                        this.showRequests();
                        this.getBackend();
                    }
                    ...
                    axios.patch('https://leaveappjson.herokuapp.com/support/1', data).then(()=>{
                        this.fetchRequests();
                        this.showRequests();
                        this.getSupport();
                    }).catch(err=>console.log(err));
                    ...
                    axios.patch('https://leaveappjson.herokuapp.com/devops/1', data).then(()=>{
                        this.fetchRequests();
                        this.showRequests();
                        this.getDevops();
                    }).catch(err=>console.log(err));
                    ...
                    let data = {"number": qa};
                    axios.patch('https://leaveappjson.herokuapp.com/qa/1', data).then(()=>{
                        this.fetchRequests();
                        this.showRequests();
                        this.getQA();
                    }).catch(err=>console.log(err));
                    ...
                    axios.patch('https://leaveappjson.herokuapp.com/avitech/1', data).then(()=>{
                        this.getQA();
                    }).catch(err=>console.log(err));
                } 
                    ...
                    axios.patch('https://leaveappjson.herokuapp.com/finatech/1', data).then(()=>{
                        this.getFinatech();
                    }).catch(err=>console.log(err));
                }
    ...
    disapproveHandler(e, ident){
        ...
        axios.patch('https://leaveappjson.herokuapp.com/requests/'+ident, data).then(()=>{
            this.fetchRequests();
            this.showRequests();
        }).catch(err=>alert(err))
    }
